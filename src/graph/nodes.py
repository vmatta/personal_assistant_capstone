...
def _capability_response(user_text: str) -> str | None:
    ...
    return (
        ...
        "I can add and list tasks or events, detect scheduling conflicts, remember facts you ask me to save, "
        "retrieve saved notes with semantic search, answer weather questions using an external API, ask clarifying "
        "questions for ambiguous requests, and require human approval before destructive actions like removing events."
    )
